...
export declare type PhoneNumberAuthenticationOverridesProps = {
    PhoneNumberAuthentication?: PrimitiveOverrideProps<ViewProps>;
...
export declare type PhoneNumberAuthenticationProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: PhoneNumberAuthenticationOverridesProps | undefined | null;
}>;
export default function PhoneNumberAuthentication(props: PhoneNumberAuthenticationProps): React.ReactElement;
